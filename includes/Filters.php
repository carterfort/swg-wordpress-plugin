...
';
	...
	/**
	 * Add the SwG Product header column to the post list table
	 * 
	 * @param array $defaults The default post list columns
	 */
	...
	/**
	 * Display the SwG product associated with a post (or Free, if free)
	 * 
	 * @param array $defaults The default post list columns
	 */
